...
Sub Service_Start (StartingIntent As Intent)
	'StartServiceAt(Null, DateTime.Now + 25 * 1000, True) ' 900 seconds/60 = 15 minutes from the current second
...
'		mqtt.Publish("SmartWatchMinoGifu/HB",  str.GetBytes("UTF8")) 'change the ping topic as needed
'		
'		counter= counter+1
'		'	Sleep(5000)
'		'	Loop
