...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "asahi.alert.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", asahi.alert.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(asahi.alert.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public asahi.alert.b4xformatter._b4xformatdata  _copyformatdata(asahi.alert.b4xformatter._b4xformatdata _data) throws Exception{
asahi.alert.b4xformatter._b4xformatdata _d = null;
...
_d = new asahi.alert.b4xformatter._b4xformatdata();
...
public asahi.alert.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
asahi.alert.b4xformatter._b4xformatdata _d = null;
...
asahi.alert.b4xformatter._b4xformatdata _data = null;
...
public asahi.alert.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (asahi.alert.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public asahi.alert.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
asahi.alert.b4xformatter._b4xformatdata _d = null;
...
_d = (asahi.alert.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public asahi.alert.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
