...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "asahi.alert.b4xinputtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", asahi.alert.b4xinputtemplate.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(asahi.alert.b4xinputtemplate parent,asahi.alert.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
asahi.alert.b4xinputtemplate parent;
