...
public static asahi.alert.b4ximageview  _createb4ximageview(anywheresoftware.b4a.BA _ba) throws Exception{
asahi.alert.b4ximageview _iv = null;
...
_iv = new asahi.alert.b4ximageview();
