...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "asahi.alert.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", asahi.alert.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public asahi.alert.b4xfloattextfield _searchfield = null;
...
_searchfield = new asahi.alert.b4xfloattextfield();
...
__c.LogImpl("921364767","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(asahi.alert.b4xsearchtemplate parent,asahi.alert.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
asahi.alert.b4xsearchtemplate parent;
